    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary to-primary-light p-12 text-primary-foreground flex-col  relative overflow-hidden">
        <div className="relative z-10">
          <div className="h-10 w-auto font-semibold text-2xl tracking-tight">NewCo®</div>
        </div>

        <div className="relative z-10">
          <h1 className="text-4xl font-bold mb-4">Transforme sua gestão de social media</h1>
          <p className="text-lg opacity-90 max-w-xl">
            Crie conteúdo com IA, gerencie aprovações e colabore com sua equipe em um só lugar.
          </p>
        </div>
        ...
        <img src="/hero-illustration.png" alt="" class="absolute inset-0 w-full h-full object-cover opacity-20"></img>
      </div>
            ...
            <form onSubmit={onSignIn} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <button type="button" className="px-0 font-normal text-xs text-primary underline-offset-4 hover:underline">Esqueceu a senha?</button>
                </div>
                <input
                  id="password"
                  name="password"
              ...
              {error && <p id={errorId} className="text-destructive text-sm">{error}</p>}
